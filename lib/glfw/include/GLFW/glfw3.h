...
/*! @brief Returns whether the Vulkan loaders and an ICD have been found.
 *
 *  This function returns whether the Vulkan loaders and any minimally functional
 *  ICD have been found.
 *
 *  The availability of a Vulkan loaders and even an ICD does not by itself
 ...
 *  return any function exported from the Vulkan loaders, including at least the
 *  following functions:
 *
 ...
 *  a platform-specific query of the Vulkan loaders as a fallback.
 *
 ...
 *
 *  If the Vulkan loaders or at least one minimally functional ICD were not found,
